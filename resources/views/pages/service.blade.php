...
">
    <div class="container text-center py-5">
        <h1 class="display-2 text-white mb-3 mt-5">Our Services</h1>
            ...
            <div class="col-12">
                <div class="services-tabs-container">
                    <div class="services-tabs-nav">
                        @php
                            $services = [
                                ['id' => 'supervision', 'icon' => 'hard-hat', 'title' => 'Engineering Supervision', 'desc' => 'Quality assurance'],
                                ['id' => 'management', 'icon' => 'chart-line', 'title' => 'Project Management', 'desc' => 'Strategic planning'],
                                ['id' => 'design', 'icon' => 'drafting-compass', 'title' => 'A & E Design', 'desc' => 'Architectural solutions'],
                                ['id' => 'feasibility', 'icon' => 'magnifying-glass-chart', 'title' => 'Feasibility Studies', 'desc' => 'Technical analysis'],
                                ['id' => 'interior', 'icon' => 'couch', 'title' => 'Interior Design', 'desc' => 'Aesthetic spaces'],
                                ['id' => 'finishing', 'icon' => 'check-to-slot', 'title' => 'Finishing Supervision', 'desc' => 'Perfection in detail'],
                                ['id' => 'bim', 'icon' => 'cube', 'title' => 'BIM Modeling', 'desc' => 'Digital construction'],
                                ['id' => 'infrastructure', 'icon' => 'road', 'title' => 'Infrastructure Design', 'desc' => 'Utility networks']
                            ];
                        @endphp

                        @foreach($services as $index => $service)
                        <button class="service-tab-btn {{ $index === 0 ? 'active' : '' }}" onclick="scrollToService('detail-{{ $service['id'] }}')">
                            <div class="tab-icon">
    ...
    <div class="container">
        ...
        @php
            $serviceDetails = [
                [
                    ...
                    'description' => 'Comprehensive oversight ensuring adherence to design specifications and quality standards throughout construction lifecycle.',
                    'features' => [
                        ['icon' => 'clipboard-check', 'title' => 'Material Quality Control', 'desc' => 'Rigorous testing of construction materials'],
                    ...
                    'image_desc' => 'Our team provides on-site supervision throughout the construction phase, ensuring every detail meets the highest quality standards. We conduct regular site inspections, monitor progress against timelines, and ensure compliance with all safety regulations and building codes.'
                ],
                [
                    'id' => 'management',
                    ...
                    'description' => 'Strategic oversight ensuring projects delivered on time, within budget, and to highest quality standards.',
                    'features' => [
                        ['icon' => 'calendar-alt', 'title' => 'Schedule Management', 'desc' => 'Detailed project scheduling and timeline'],
                    ...
                    'image_desc' => 'We employ advanced project management methodologies to coordinate all aspects of your construction project. From initial planning to final delivery, we ensure seamless communication between stakeholders, efficient resource allocation, and strict adherence to timelines and budgets.'
                ],
                [
                    'id' => 'design',
                    ...
                    'features' => [
                        ['icon' => 'building', 'title' => 'Architectural Planning', 'desc' => 'Creative space planning and facade design'],
                    ...
                    'image_desc' => 'Our design team creates innovative architectural solutions that balance aesthetics, functionality, and sustainability. We produce detailed engineering drawings, 3D visualizations, and construction documents that serve as the blueprint for successful project execution.'
                ],
                [
                    'id' => 'feasibility',
                    ...
                    'features' => [
                        ...
                        ['icon' => 'exclamation-triangle', 'title' => 'Risk Assessment', 'desc' => 'Risk identification and quantification'],
                        ['icon' => 'search-location', 'title' => 'Site Evaluation', 'desc' => 'Technical assessment of site suitability'],
                    ...
                    'image_desc' => 'Before breaking ground, we conduct thorough feasibility studies to evaluate project viability. Our analysis includes market research, financial projections, site assessments, and regulatory compliance reviews to ensure your investment is sound and strategically positioned.'
                ],
                [
                    'id' => 'interior',
                    ...
                    'features' => [
                        ['icon' => 'ruler-combined', 'title' => 'Space Planning', 'desc' => 'Optimal space utilization and layout design'],
                        ['icon' => 'palette', 'title' => 'Color Scheme Development', 'desc' => 'Comprehensive color palettes selection'],
                    ...
                    'image_desc' => 'We create interior environments that inspire productivity, comfort, and engagement. Our design approach considers spatial dynamics, lighting effects, material textures, and ergonomic considerations to deliver spaces that are both beautiful and practical for daily use.'
                ],
                [
                    'id' => 'finishing',
                    ...
                    'image_desc' => 'During the final stages of construction, our finishing supervision ensures every detail meets exacting standards. We oversee installation of fixtures, finishes, and fittings, conduct thorough quality checks, and manage the snagging process to deliver a flawless final product.'
                ],
                [
                    'id' => 'bim',
                    'title' => 'BIM Modeling',
                    ...
                    'image_desc' => 'Our BIM services transform traditional construction documentation into intelligent 3D models that enable better decision-making. We create coordinated models that identify potential conflicts before construction begins, saving time and reducing costly rework on site.'
                ],
                [
                    'id' => 'infrastructure',
                    ...
                    'image_desc' => 'We design robust infrastructure systems that support community development and economic growth. Our expertise includes transportation networks, utility distribution systems, drainage solutions, and sustainable infrastructure that meets current needs while accommodating future expansion.'
                ]
            ];
        @endphp
        ...
        <div id="detail-{{ $service['id'] }}" class="service-detail-wrapper mb-5">
            <div class="detail-card">
                {{-- Mobile Layout: Always show content first, then image --}}
                <div class="d-block d-lg-none">
                    ...
                    <div class="detail-image-side mt-4">
                        <div class="image-container">
                            <img src="{{ $service['image'] }}" alt="{{ $service['title'] }}" class="service-main-image">
                        </div>
                        <div class="image-description-card mt-3">
                    ...
                    {{-- Mobile: Features After Image --}}
                    <div class="detailed-features mt-4">
...
<style>
    ...
    .section-title, .detail-section-title {
        font-size: 2rem;
        font-weight: 700;
        color: var(--dark-blue);
    ...
    .section-subtitle, .detail-section-subtitle {
        font-size: 1rem;
        color: var(--gray-700);
        max-width: 600px;
        margin: 0 auto;
    ...
    @media (min-width: 992px) {
        .detail-content-side, .detail-image-side {
            display: flex;
